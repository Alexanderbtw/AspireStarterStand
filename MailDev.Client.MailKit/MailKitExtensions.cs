...
public static class MailKitExtensions
{
        ...
        Action<MailKitClientSettings>? configureSettings = null)
    {
        ...
        AddMailKitClient(
            builder: builder,
            configurationSectionName: $"{MailKitClientSettings.DefaultConfigSectionName}:{name}",
        ...
        Action<MailKitClientSettings>? configureSettings = null)
    {
        AddMailKitClient(
            builder: builder,
            configurationSectionName: MailKitClientSettings.DefaultConfigSectionName,
            configureSettings: configureSettings,
        ...
        else
        {
            builder.Services.AddKeyedScoped(
                ...
                implementationFactory: (
                    _,
                    _) => new MailKitClientFactory(settings));
        }
